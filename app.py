# ============================================================
# app.py - versão completa e corrigida com sincronização retroativa
# ============================================================
...
@app.route('/')
def home():
    return jsonify({'status': 'ok', 'mensagem': 'API Controle de Obras ativa'}), 200

# ============================================================
# ROTA DE INSERÇÃO DE PAGAMENTO
# ============================================================
