...
# Relação inversa do Imovel
AdminBoleto.imovel = db.relationship('Imovel', backref='boletos', lazy=True)


# ===================================================================================
# FUNÇÃO: EXTRAÇÃO DE DADOS DO PDF DO BOLETO
# ===================================================================================
...
@app.route('/imoveis/<int:imovel_id>/boletos', methods=['GET'])
@jwt_required()
...
@app.route('/imoveis/<int:imovel_id>/boletos', methods=['POST'])
@jwt_required()
def criar_boleto_admin(imovel_id):
    ...
    try:
        ...
        if codigo_barras:
            existente = AdminBoleto.query.filter_by(imovel_id=imovel_id, codigo_barras=codigo_barras).first()
            if existente:
...
@app.route('/imoveis/<int:imovel_id>/boletos/extrair-pdf', methods=['POST'])
@jwt_required()
...
@app.route('/imoveis/<int:imovel_id>/boletos/<int:boleto_id>', methods=['PUT'])
@jwt_required()
...
@app.route('/imoveis/<int:imovel_id>/boletos/<int:boleto_id>/pagar', methods=['POST'])
@jwt_required()
...
@app.route('/imoveis/<int:imovel_id>/boletos/<int:boleto_id>', methods=['DELETE'])
@jwt_required()
...
@app.route('/imoveis/<int:imovel_id>/boletos/<int:boleto_id>/arquivo', methods=['GET'])
@jwt_required()
...
@app.route('/imoveis/<int:imovel_id>/boletos/resumo', methods=['GET'])
@jwt_required()
